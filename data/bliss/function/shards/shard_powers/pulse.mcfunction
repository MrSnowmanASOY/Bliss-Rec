...
execute at @s run playsound minecraft:entity.warden.sonic_boom master @a[distance=..50] ^ ^ ^ 100 2
execute at @s run playsound minecraft:entity.warden.sonic_boom master @a[distance=..50] ^ ^ ^5 100 1
execute at @s run playsound minecraft:entity.warden.sonic_boom master @a[distance=..50] ^ ^ ^10 100 0.5
execute at @s run playsound minecraft:entity.warden.sonic_boom master @a[distance=..50] ^ ^ ^15 100 0.25
execute at @s run playsound minecraft:entity.warden.sonic_boom master @a[distance=..50] ^ ^ ^20 100 0
...
scoreboard players add @s Timer 360

# Flare
execute at @s anchored eyes positioned ^ ^ ^1 run function bliss:shards/shard_flare/pulse_flare
execute at @s anchored eyes positioned ^ ^ ^1 run particle minecraft:flash ~ ~ ~ 0 0 0 0 1 force