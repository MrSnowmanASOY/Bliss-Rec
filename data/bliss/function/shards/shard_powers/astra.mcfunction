...
execute as @s at @s run execute positioned ~1 ~15 ~1 run summon arrow ^ ^ ^3 {Tags:["projectile1"],damage:0.25,PierceLevel:5,Glowing:true}
execute as @s at @s run execute positioned ~-1 ~15 ~-1 run summon arrow ^ ^ ^3 {Tags:["projectile2"],damage:0.25,PierceLevel:5,Glowing:true}
execute as @s at @s run execute positioned ~1 ~15 ~-1 run summon arrow ^ ^ ^3 {Tags:["projectile3"],damage:0.25,PierceLevel:5,Glowing:true}
execute as @s at @s run execute positioned ~-1 ~15 ~1 run summon arrow ^ ^ ^3 {Tags:["projectile4"],damage:0.25,PierceLevel:5,Glowing:true}
execute as @s at @s run execute positioned ~ ~15 ~ run summon arrow ^ ^ ^3 {Tags:["projectile5"],damage:0.25,PierceLevel:5,Glowing:true}
